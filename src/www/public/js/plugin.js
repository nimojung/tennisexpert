(function ( $ ) {
    ...
    var methods = {
        init : function(options) {
            ...
            // Create percentage
            var percentage = $('<div class="progress-percentage" style="margin-left: 10px; text-align:center;"></div>');
            // var percentage = $('<div class="progress-percentage" style="width: 100px; margin-left:'+ magin +'"></div>');
